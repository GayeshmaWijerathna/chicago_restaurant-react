    ...
    render() {
        return (
            <div className="min-h-screen flex flex-col">
                ...
                <div className="flex flex-col justify-center items-center mt-3 min-h-0">
                    <table className="w-full mx-auto">
                        <tr className="bg-gray-400">
                            <th className="text-[12px] font-bold border-black border-[0.5px] px-1 ">
                                Item Code
                            </th>
                            <th className="text-[12px] font-bold border-black border-[0.5px] px-1 ">
                                Item Name
                        ...
                        {this.state.itemList.length === 0 ? (
                            ...
                            this.state.itemList.map((item, index) => (
                                <tr key={index} className="border-black text-center border-[0.5px] px-1 ">
                                    <td className="border-black text-[12px] border-[0.5px] px-1 ">
                                        {item.product.id}
                                    </td>
                                    <td className="border-black text-[12px] border-[0.5px] px-1 ">
                                        {item.product.name}
                                    ...
                                    <td className={"text-[12px] border-black border-[0.5px] px-1"}>
                                        {item.itemCount}
                                    </td>
                                    <td className={"text-[12px] border-black border-[0.5px] px-1"}>
